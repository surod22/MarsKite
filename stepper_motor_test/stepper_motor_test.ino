...
/* Retrieved by Stephen Hoover, AnotherSolipsist */
...
//---( Steps per OUTPUT SHAFT of gear reduction - this isn't quite right yet)---
#define STEPS_PER_OUTPUT_REVOLUTION 524 //8 * 64  //2048  
...
{
  //small_stepper.setSpeed(50);   // SLOWLY Show the 4 step sequence 
